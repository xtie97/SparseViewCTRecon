...
def test(flag, rfov=250):
    ...
    root_dir = '/media/xintie/Elements/DeepEnChroma/Data_rcn/results_sino_61/output/'
    target_dir = '/media/xintie/Elements/DeepEnChroma/Data_rcn/results_sino_61/output_rcn/'
    ...
    for fileid in tqdm(range(len(filename_high))):
        ...
        savefile = target_dir + filename_high[fileid].replace(".raw", "_rcn.raw")
